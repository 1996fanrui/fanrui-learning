...
/**
 * @author fanrui
 * @time 2019-12-12 20:57:54
 * @desc: 反射机制就是可以把一个类,类的成员(函数,属性),当成一个对象来操作
 * quote: https://blog.csdn.net/ljphhj/article/details/12858767#
 */
public class ReflectTest {
    ...
    public static void Demo2() throws ClassNotFoundException
    {
        ...
        class1 = Class.forName("com.dream.reflect.Person");
    ...
    {
        Class<?> class1 = null;
        class1 = Class.forName("com.dream.reflect.SuperMan");
    ...
    public static void Demo7() throws ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException
    {
        ...
        System.out.println("调用有参方法walk(int m)：");
        method = class1.getMethod("swimming",int.class);
        Object invoke = method.invoke(null, 100);
        System.out.println("swimming 方法返回值为 " + invoke);
    }
...
class SuperMan extends Person implements ActionInterface
{
    ...
    public static int swimming(int num){
        System.out.println(num + " 个静态的超人会游泳耶～～");
        return num;
    }
